...
public class AbsoluteMovement extends Movement {
	private float x = 0;
	private float y = 0;
	...
	public AbsoluteMovement(float absoluteX, float absoluteY, float curvature, float velocity, float angularVelocity,
		...
		super(0, 0, curvature, velocity, angularVelocity, acceleration, angularacceleration);
		this.x = absoluteX;
		this.y = absoluteY;
		this.heading = heading;
	}
	...
	public String toString() {
		...
		builder.append("AbsoluteMovement [x=").append(x).append(", y=").append(y).append(", heading=").append(heading)
				.append(", deltaX()=").append(getDeltaX()).append(", deltaY()=").append(getDeltaY())
				.append(", curvature()=").append(getCurvature()).append(", velocity()=").append(getVelocity())
